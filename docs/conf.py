...
project = "test gh-pypi mit-or-apache-2-0 macos 3.10"
...
release = metadata.version("test_gh_pypi_mit_or_apache_2_0_macos_310")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/test-gh-pypi-mit-or-apache-2-0-macos-310",
        ...
        },
        {
            ...
            "url": (
                "https://github.com/"
                "whiteprints-tests/"
                "test-gh-pypi-mit-or-apache-2-0-macos-310"
            ),
